...
export default function LoginScreen({ navigation }: RouterProps) {
    ...
    return (
        <View className='px-5 flex-1 justify-center items-center bg-[#151515]'>
            <View>
                <Text className='text-3xl font-bold mb-12 text-[#f1f1f1]'>Inicia Sesión</Text>
            </View>
            <KeyboardAvoidingView className='w-full' behavior='padding'>
                ...
                <TextInput
                    ...
                    className='rounded-sm px-4 py-3 bg-white mt-3 w-full'
                ...
                {loading ? <ActivityIndicator size='large' color='#0000f' className='mt-10' />
                    :
                    <>
                        <View className='bg-purple-800 text-white w-full mt-6'>
